...
public static class CollisionsManager
{
  ...
  public static void Initialize()
  {
    ...
    SpatialSystem.OnCollisionEnterEvent = (a, b) => OnCollisionEnter?.Invoke(a, b);
  ...
  public static void Update(float dt)
  {
    ...
    SpatialSystem.UpdatePositions();
    SpatialSystem.UpdateCollisions();
  }

  public static IEnumerable<GameObject> GetPotentialCollisions(GameObject obj)
  {
    var potentialObjects = SpatialSystem.GetPotentialCollisions(obj);
  ...
  {
    var performanceInfo = SpatialSystem.GetPerformanceInfo();
