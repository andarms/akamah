...
public class InventoryWindow(Vector2 size, int columns = 8, int rows = 4) : Component
{
  ...
  private void DrawHeader()
  {
    ...
    int titleY = (int)(Owner.Position.Y + (headerHeight - 32) / 2);
    ...
    if (Inventory != null)
    {
      ...
      DrawTextEx(AssetsManager.DefaultFont, stats, new Vector2(Owner.Position.X + 8, titleY), 16, 1, Color.LightGray);
    }
  }
