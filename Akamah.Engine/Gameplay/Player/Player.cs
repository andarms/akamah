...
public class Player : GameObject
{
  ...
  public Tool Tool { get; private set; } = ToolsFactory.CreateSword(Interactions.Equipment.Material.Wood);
  ...
  public override void Update(float deltaTime)
  {
    ...
    {
      Tool = ToolsFactory.CreateSword(Interactions.Equipment.Material.Wood);
      Console.WriteLine($"Equipped: {Tool}");
    }
    else if (IsKeyPressed(KeyboardKey.Two))
    {
      Tool = ToolsFactory.CreateAxe(Interactions.Equipment.Material.Stone);
      Console.WriteLine($"Equipped: {Tool}");
    }
    else if (IsKeyPressed(KeyboardKey.Three))
    {
      Tool = ToolsFactory.CreatePickaxe(Interactions.Equipment.Material.Wood);
      Console.WriteLine($"Equipped: {Tool}");
    }
    else if (IsKeyPressed(KeyboardKey.Four))
    {
      Tool = ToolsFactory.CreateShovel(Interactions.Equipment.Material.Stone);
      Console.WriteLine($"Equipped: {Tool}");
    }
